...
import asynctorndb
from config.config_mysql import config_mysql
import datetime
...
class ModelBase(object):
    ...
    def __get_connection(self):
        conn = asynctorndb.Connection(host=config_mysql.get('host'), database=config_mysql.get('database'), user=config_mysql.get('user'),
